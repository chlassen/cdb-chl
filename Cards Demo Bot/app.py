...
app = Flask(__name__)
api = WebexTeamsAPI(access_token="YWIzNTdlNDctZGRlNC00ZDM3LWFkYTAtNmNiNjE0MmI4NDczNGMyZDUxMjUtM2Yx_PF84_33672567-1029-48fb-ba77-7fe2001ee897")
...
def cardsubmitted():
    if request.method == 'POST':
        ...
        print(myEmail)
        print(myTel)
        smart = smartsheet.Smartsheet('9wgxvk3yRaaVKbeaJUJUERtkl4repn7jydrDl') #Smartsheet Access Token
        ...
        newRow.cells.append({ 'column_id': 7816798585284484, 'value': myName })
        #
        newRow.cells.append({ 'column_id': 6690898678441860, 'value': myEmail, 'strict': False })
        newRow.cells.append({ 'column_id': 8942698492127108, 'value': myTel, 'strict': False })
        response = smart.Sheets.add_rows(1737257204901764, newRow) # The -- xxxxxxxxxxxxxx -- on this line is the sheet ID.
    return 'OK', 200
